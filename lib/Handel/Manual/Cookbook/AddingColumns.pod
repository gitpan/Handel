...
If you need a quick fix in a script or want to alter all instance of Handel objects within the same process, you
...
The better, more polite approach is to make your own custom classes and use [ab]use them instead.
    ...
    __PACKAGE__->storage->item_class('My::Cart::Item');
    __PACKAGE__create_accessors;
...
First we need to create custom storage classes for the Cart and Item interface classes.
    ...
    __PACKAGE__->item_class('My::Cart');
...
=head2 Create Cart and Item Classes
    ...
    __PACKAGE__storage_class('My::Storage::Cart::Item');
...
L<Handel::Storage>, L<Handel::Storage::DBIC>, L<Handel::Storage::Cart>, L<Handel::Storage::Cart::Item>
