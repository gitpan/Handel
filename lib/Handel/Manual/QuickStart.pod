...
To create a new application with Handel classes, run C<handel>: and give it a new application name:
    ...
    Created MyApp\script\myapp_setup.pl
...
permissions to create tables.
    ...
    $ cd MyApp
    $ perl script/myapp_setup.pl --dsn dbi:mysql:handel:localhost --user myuser --pass mypass
...
database in MyApp/data/handel.db
    ...
    $ cd MyApp
    $ perl script/myapp_setup.pl --default
    Installed/created database schema
...
application will be connecting to:
    ...
    created "C:\MyApp\script\myapp_createdb.pl"
...
permissions to create tables.
    ...
    $ cd MyApp
    $ perl script/myapp_createdb.pl --dsn mydsn --user myuser --pass mypass
    Installed/created database schema
