...
B<Until 0.08 is released, please use the DBIx-Class-current branch from the Bast repository:>
...
Version 0.07 or greater. This is used by DBIC and the quick start code to install the schema to a db. You can
